...
SOURCEFILES_QUOTED_IF_SPACED=config.asm finger.asm Simple1.asm LCD.asm external_memoy.asm counter24b.asm Multiplication.asm ADC.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/config.o ${OBJECTDIR}/finger.o ${OBJECTDIR}/Simple1.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/external_memoy.o ${OBJECTDIR}/counter24b.o ${OBJECTDIR}/Multiplication.o ${OBJECTDIR}/ADC.o
POSSIBLE_DEPFILES=${OBJECTDIR}/config.o.d ${OBJECTDIR}/finger.o.d ${OBJECTDIR}/Simple1.o.d ${OBJECTDIR}/LCD.o.d ${OBJECTDIR}/external_memoy.o.d ${OBJECTDIR}/counter24b.o.d ${OBJECTDIR}/Multiplication.o.d ${OBJECTDIR}/ADC.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/config.o ${OBJECTDIR}/finger.o ${OBJECTDIR}/Simple1.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/external_memoy.o ${OBJECTDIR}/counter24b.o ${OBJECTDIR}/Multiplication.o ${OBJECTDIR}/ADC.o

# Source Files
SOURCEFILES=config.asm finger.asm Simple1.asm LCD.asm external_memoy.asm counter24b.asm Multiplication.asm ADC.asm
...
${OBJECTDIR}/finger.o: finger.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/finger.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/finger.lst\" -e\"${OBJECTDIR}/finger.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/finger.o\" \"finger.asm\" 
...
${OBJECTDIR}/Simple1.o: Simple1.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Simple1.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Simple1.lst\" -e\"${OBJECTDIR}/Simple1.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Simple1.o\" \"Simple1.asm\" 
...
${OBJECTDIR}/external_memoy.o: external_memoy.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/external_memoy.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/external_memoy.lst\" -e\"${OBJECTDIR}/external_memoy.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/external_memoy.o\" \"external_memoy.asm\" 
...
${OBJECTDIR}/counter24b.o: counter24b.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/counter24b.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/counter24b.lst\" -e\"${OBJECTDIR}/counter24b.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/counter24b.o\" \"counter24b.asm\" 
...
${OBJECTDIR}/Multiplication.o: Multiplication.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Multiplication.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Multiplication.lst\" -e\"${OBJECTDIR}/Multiplication.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Multiplication.o\" \"Multiplication.asm\" 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Sec_dict.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w -x -u_DEBUG -z__ICD2RAM=1 -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_SIMULATOR=1 $(MP_LINKER_DEBUG_OPTION) -odist/${CND_CONF}/${IMAGE_TYPE}/Sec_dict.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
else
dist/${CND_CONF}/${IMAGE_TYPE}/Sec_dict.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
